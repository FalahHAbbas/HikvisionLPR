...
public class TruckTrip {
    ...
    public TruckTrip(String id, String vehicleId, String plateNumber, int provinceId, String provinceName, int plateCharacterId, String plateCharacter, int location, int status, String cargoDescription, String deliveryAddress, int dischargeType, int cargoTypeId, String cargoTypeName, int quantity, double weight, String driverName, String driverPhone) {
        this.id = id;
